...
public class MainMenu extends JFrame{
    ...
    MainMenu() {
        ...
        playButton.setIcon(new ImageIcon("src//Pictures//playbtn.jpg"));
        playButton.setText("");
        playButton.setBackground(Color.black);
        playButton.setBorder(BorderFactory.createLineBorder(Color.black));
        settingsButton.setIcon(new ImageIcon("src//Pictures//settingsbtn.jpg"));
        settingsButton.setText("");
        settingsButton.setBackground(Color.black);
        settingsButton.setBorder(BorderFactory.createLineBorder(Color.black));
        highscoreButton.setIcon(new ImageIcon("src//Pictures//highscorebtn.jpg"));
