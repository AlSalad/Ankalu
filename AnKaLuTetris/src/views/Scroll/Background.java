...
public class Background {
    ...
    public Background(int x, int y) {
        ...
        try {
            image = ImageIO.read(new File("D:/User/Luka/Bilder/Camera Roll/Hearthstone Screenshot 05-29-16 11.50.56.png"));
        }
...
//        return "Scroll: x=&amp;amp;amp;quot; + getX() + ", y=" + getY() + ", height=" + image.getHeight() + ", width=" + image.getWidth();
//    }
